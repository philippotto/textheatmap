...
},{}],"xaEDxu":[function(_dereq_,module,exports){
(function (process){
...
},{"Zbi7gb":2}],"eventemitter2":[function(_dereq_,module,exports){
module.exports=_dereq_('xaEDxu');
},{}],"6Vf+Vc":[function(_dereq_,module,exports){
(function (global){
/**
 * @license
...
},{"./diff_match_patch":9,"./insert":10,"./op":11,"./retain":12,"lodash":"6Vf+Vc"}],8:[function(_dereq_,module,exports){
(function() {
...
},{"./delta":7,"./insert":10,"./retain":12,"lodash":"6Vf+Vc"}],9:[function(_dereq_,module,exports){
(function() {
  var googlediff;
...
},{"./op":11,"lodash":"6Vf+Vc"}],11:[function(_dereq_,module,exports){
(function() {
  var Op, _;
...
},{"lodash":"6Vf+Vc"}],12:[function(_dereq_,module,exports){
(function() {
  var Op, RetainOp, _,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"./op":11,"lodash":"6Vf+Vc"}],"tandem-core":[function(_dereq_,module,exports){
module.exports=_dereq_('teqG2h');
},{}],"teqG2h":[function(_dereq_,module,exports){
(function() {
  module.exports = {
    Delta: _dereq_('./delta'),
...
},{}],"ehxko1":[function(_dereq_,module,exports){
//  Underscore.string
...
},{"./dom":21,"./format":23,"./lib/linked-list":26,"./line":29,"./normalizer":39,"./utils":45,"lodash":"6Vf+Vc","tandem-core":"teqG2h"}],21:[function(_dereq_,module,exports){
...
},{"lodash":"6Vf+Vc","underscore.string":"ehxko1"}],22:[function(_dereq_,module,exports){
...
},{"./document":20,"./dom":21,"./line":29,"./renderer":41,"./selection":42,"lodash":"6Vf+Vc","tandem-core":"teqG2h"}],23:[function(_dereq_,module,exports){
...
},{"./dom":21,"./utils":45,"lodash":"6Vf+Vc"}],24:[function(_dereq_,module,exports){
...
},{"./dom":21,"./format":23,"./lib/linked-list":26,"./utils":45,"lodash":"6Vf+Vc"}],25:[function(_dereq_,module,exports){
...
},{"../dom":21,"../normalizer":39,"lodash":"6Vf+Vc"}],28:[function(_dereq_,module,exports){
var Range, _;
...
},{"lodash":"6Vf+Vc"}],29:[function(_dereq_,module,exports){
...
},{"./dom":21,"./format":23,"./leaf":24,"./lib/linked-list":26,"./line":29,"./normalizer":39,"./utils":45,"lodash":"6Vf+Vc","tandem-core":"teqG2h"}],30:[function(_dereq_,module,exports){
...
},{"../dom":21,"../format":23,"lodash":"6Vf+Vc","tandem-core":"teqG2h"}],31:[function(_dereq_,module,exports){
...
},{"../dom":21,"./tooltip":37,"lodash":"6Vf+Vc"}],32:[function(_dereq_,module,exports){
...
},{"../dom":21,"../line":29,"lodash":"6Vf+Vc","tandem-core":"teqG2h"}],33:[function(_dereq_,module,exports){
...
},{"../dom":21,"./tooltip":37,"lodash":"6Vf+Vc"}],34:[function(_dereq_,module,exports){
...
},{"../dom":21,"../utils":45,"eventemitter2":"xaEDxu","lodash":"6Vf+Vc"}],35:[function(_dereq_,module,exports){
...
},{"../document":20,"../dom":21,"lodash":"6Vf+Vc","tandem-core":"teqG2h"}],36:[function(_dereq_,module,exports){
...
},{"../dom":21,"../utils":45,"lodash":"6Vf+Vc"}],37:[function(_dereq_,module,exports){
...
},{"../dom":21,"../normalizer":39,"lodash":"6Vf+Vc"}],38:[function(_dereq_,module,exports){
...
},{"lodash":"6Vf+Vc","tandem-core":"teqG2h"}],39:[function(_dereq_,module,exports){
...
},{"./dom":21,"./utils":45,"lodash":"6Vf+Vc"}],40:[function(_dereq_,module,exports){
...
Quill = (function(_super) {
  ...
  Quill.prototype.batchFormatText = function(paramArray) {
    var delta, end, formats, mergedDelta, params, source, start, _i, _len, _ref;
    mergedDelta = {
      ops: [],
      endLength: 0,
      startLength: 0
    ...
    for (_i = 0, _len = paramArray.length; _i < _len; _i++) {
      params = paramArray[_i];
      _ref = this._buildParams.apply(this, params), start = _ref[0], end = _ref[1], formats = _ref[2], source = _ref[3];
      if (!(end > start)) {
        return;
      }
      formats = _.reduce(formats, (function(_this) {
    ...
    return this.editor.applyDelta(mergedDelta, source);
  };
...
},{"../package.json":19,"./dom":21,"./editor":22,"./format":23,"./lib/range":28,"./modules/authorship":30,"./modules/image-tooltip":31,"./modules/keyboard":32,"./modules/link-tooltip":33,"./modules/multi-cursor":34,"./modules/paste-manager":35,"./modules/toolbar":36,"./modules/undo-manager":38,"./themes/default":43,"./themes/snow":44,"eventemitter2":"xaEDxu","lodash":"6Vf+Vc","tandem-core":"teqG2h","underscore.string":"ehxko1"}],41:[function(_dereq_,module,exports){
...
},{"./dom":21,"./normalizer":39,"./utils":45,"lodash":"6Vf+Vc"}],42:[function(_dereq_,module,exports){
...
},{"./dom":21,"./leaf":24,"./lib/range":28,"lodash":"6Vf+Vc"}],43:[function(_dereq_,module,exports){
var DefaultTheme;
...
},{"../../dom":21,"../../lib/color-picker":25,"../../lib/picker":27,"../default":43,"lodash":"6Vf+Vc"}],45:[function(_dereq_,module,exports){
var DOM, Utils, _;
